...
import com.luyuesports.joeyphotoselector.utils.Utils;
...
public class ImageSelectorActivity extends FragmentActivity implements ImageSelectorFragment.Callback {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pathList != null && pathList.size() > 0) {
                    ...
                    data.putStringArrayListExtra(EXTRA_RESULT, (ArrayList<String>) pathList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageSelector.IMAGE_CROP_CODE && resultCode == RESULT_OK) {
            ...
            intent.putStringArrayListExtra(EXTRA_RESULT, (ArrayList<String>) pathList);
